# Generated by Django 5.0.7 on 2024-08-01 19:46
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter book language', max_length=200, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='catalog.author', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
